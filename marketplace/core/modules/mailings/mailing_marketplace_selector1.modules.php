...
dol_include_once("/marketplace/class/myobject.class.php");


/**
 * mailing_mailinglist_marketplace
 */
class mailing_mailing_marketplace_selector1 extends MailingTargets
{
	// CHANGE THIS: Put here a name not already used
	public $name = 'mailing_marketplace_selector1';
	// CHANGE THIS: Put here a description of your selector module
	public $desc = 'Emailing target selector 1';
	...
	{
		return '<a href="'.dol_buildpath('/marketplace/myobject_card.php', 1).'?id='.$id.'">'.img_object('', "generic").'</a>';
	}
	...
	public function add_to_target($mailing_id)
	{
		...
		if ($result) {
			...
			dol_syslog("mailinglist_marketplace_myobject.modules.php: mailing ".$num." targets found");
			...
			while ($i < $num) {
				...
				if ($old != $obj->email) {
					$target[$j] = array(
						...
						'source_id' => $obj->id,
						'source_type' => 'myobject@marketplace'
					);
					$old = $obj->email;
					$j++;
				}
