...
class modMarketplace extends DolibarrModules
{
	...
	public function init($options = '')
	{
		...
		$result20=$extrafields->addExtraField('marketplace_date_stop_earning', "DateStopEarning", 'datetime', 110167, '255', 'product', 0, 0, '', $param, 1, '', 1, 'ToStopAllEarningAfterAGivenDate', '', '', 'marketplace@marketplace', 'isModEnabled("marketplace")', 0, 0);
