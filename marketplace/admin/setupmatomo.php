...
/**
 * \file    marketplace/admin/setupmatomo.php
 * \ingroup marketplace
 * \brief   Marketplace setup page for Matomo.
 */
...
$formSetup->newItem('MARKETPLACE_ENABLE_MATOMO')->setAsYesNo();

$item = $formSetup->newItem('MARKETPLACE_MATOMO_SITE_KEY');
$item->helpText = $langs->trans("MARKETPLACE_MATOMO_SITE_KEY_HELP");
$item->cssClass = 'minwidth500';

$item = $formSetup->newItem('MARKETPLACE_MATOMO_SERVER_URL');
$item->helpText = $langs->trans("MARKETPLACE_MATOMO_SERVER_URL_HELP");
$item->cssClass = 'minwidth500';
...
print dol_get_fiche_head($head, 'setupmatomo', $langs->trans($page_name), -1, "fa-store");
