...
//}
//if (! $user->hasRight('marketplace', 'myobject', 'read')) {
//	accessforbidden();
//}
//restrictedArea($user, 'marketplace', 0, 'marketplace_myobject', 'myobject', '', 'rowid');
//if (empty($user->admin)) {
...
// Draft MyObject
if (isModEnabled('marketplace') && $user->rights->marketplace->read)
{
	$langs->load("orders");
...
if (isModEnabled('marketplace') && $user->rights->marketplace->read)
{
	...
	$sql.= " FROM ".MAIN_DB_PREFIX."marketplace_myobject as s";
	//if (! $user->rights->societe->client->voir && ! $socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
