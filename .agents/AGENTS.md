...
This project contains the sources of some external modules designed for the Dolibarr ERP and CRM application.
...
- SQL scripts for table and index creation must be placed in `mymodule/sql/` (see existing files for examples)
