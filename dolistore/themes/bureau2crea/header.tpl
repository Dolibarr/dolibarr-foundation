...
{/if}
		...
		<link rel="icon" type="image/vnd.microsoft.icon" href="{$img_ps_dir}dolistore.ico.ico?{$img_update_time}" />
		<link rel="shortcut icon" type="image/x-icon" href="{$img_ps_dir}dolistore.ico.ico?{$img_update_time}" />
