...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr bgcolor="#CCCCCC">
	...
	<td nowrap="nowrap"><b><?php echo aff("Description", "Description", $iso_langue_en_cours); ?></b></td>
...
if (sizeof($result))
{
	foreach ($result AS $row)	// For each product
	{
		...
		$query = 'SELECT display_filename FROM '._DB_PREFIX_.'product_download
		...
		<tr bgcolor="<?php echo $colorTab; ?>">
			...
			<?php 
			echo "<br>(".$ref_product.")"; 
			if ($active) echo '<img src="../../img/os/2.gif" alt="Enabled" title="Enabled" style="padding: 0px 5px;"> '.aff("Actif", "Enabled", $iso_langue_en_cours);
			else echo '<img src="../../img/os/6.gif" alt="Enabled" title="Enabled" style="padding: 0px 5px;"> '.aff("Inactif", "Disabled", $iso_langue_en_cours);
			?>
			</td>
		    <td>
			<?php 
...
if ($totalamount > 0)
{
	...
	{
		echo aff("Reversements déjà reçus: ","Last payments recevied: ", $iso_langue_en_cours);
		print '<br>'."\n";
	...
	// Remain to receive
	echo aff("Montant restant à réclamer: ","Remained amount to claim: ", $iso_langue_en_cours);
