...
<div id="product-informations" class="panel product-tab">
    ...
    <div class="form-group">
         <label class="control-label col-lg-3" for="date-creation">
             <span class="label-tooltip" data-toggle="tooltip"
                     title="{l s="Date added"}">
                     {$bullet_common_field} {l s="Date added"}
             </span>
         </label>
         <div class="col-lg-3">
	...
	<div class="form-group redirect_product_options" style="display:none">
		<label class="control-label col-lg-3" for="dolibarr_disable_info">
			<span class="label-tooltip" data-toggle="tooltip"
			title="{l s='Used to define the reason for deactivation of the product sheet.'}">
