...
print '<br>';
print aff(
'Toute vente sera d\'abord encaissée par l\'association Dolibarr. Tous les 2 mois, vous pouvez réclamer le montant encaissé qui vous sera reversé (L\'association prenant 20% pour soutenir le développement du projet Dolibarr ERP/CRM)...',
'Payment for any sell will be first received by the Dolibarr foundation. Every two month, from your account, you can ask your money back (The foundation redistribute 80% of payments, the remaining 20% are kept to help the development of Dolibarr ERP/CRM project)...',
$iso_langue_en_cours);
