 ...
 <!--
  ...
  --> 	
   ...
   <tr>
    ...
    <td>
        <input size="11" maxlength="14" name="priceTI" id="priceTI" value="<?php if ($_POST["priceTI"] != 0 && $_POST["priceTI"] != "") echo $_POST["priceTI"]; ?>" onkeyup="javascript:this.value = this.value.replace(/,/g, '.');" type="text"> Euros
    </td>
  </tr>   
  ...
  <tr>
    <td nowrap="nowrap" valign="top"><?php echo aff("R&eacute;sum&eacute <i>(apparaitra dans les <br> moteurs de recherches)</i>: ", "Short description <i>(appears in search<br> results)</i> : ", $iso_langue_en_cours); ?></td>
    <td nowrap="nowrap">    	
        <?php for ($x = 0; $languageTAB[$x]; $x++ ) { ?>
        	<textarea name="resume_<?php echo $languageTAB[$x]['id_lang']; ?>" cols="30" rows="3" ><?php echo $_POST["resume_".$languageTAB[$x]['id_lang']]; ?></textarea> 
			<?php echo $languageTAB[$x]['iso_code']; ?> 
            <img src="<?php echo $languageTAB[$x]['img']; ?>" alt="<?php echo $languageTAB[$x]['iso_code']; ?>"><br /><br />
        <?php } ?>
    </td>
