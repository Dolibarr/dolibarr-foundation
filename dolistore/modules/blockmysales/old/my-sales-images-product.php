...
include(dirname(__FILE__).'/resize-image.php');
		...
		foreach ($result AS $row) {		   
		  ...
		  <tr>
			<td nowrap="nowrap" valign="top">
				<img src="../../img/p/<?php echo "$product_id-$id_image";?>.jpg" />
			</td>
			<td nowrap="nowrap" valign="top">
...
<table width="100%" border="0" cellspacing="10" cellpadding="0">  
  <tr>
    <td nowrap="nowrap" valign="top" align="center" colspan="2">		         
        ...
        <button <?php print sizeof($row)?'':'disabled="true"'; ?> type="button" onclick="JavaScript: alert('<?php aff("Votre module/produit a été ajouté", "Module/product added", $iso_langue_en_cours); ?>'); window.location='../../index.php';">			
