	...
	public function __construct($db)
	{
		...
		*/
		...
		/*$this->menu[$r++]=array('fk_menu'=>'',			                // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'position'=>1000+$r,
								'enabled'=>'isModEnabled("captureserver")',	// Define condition to show or hide menu entry. Use '$conf->captureserver->enabled' if entry must be visible if module is enabled.
		...
		*/
		...
		$this->menu[$r++]=array('fk_menu'=>'fk_mainmenu=tools',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								...
								'perms'=>'$user->hasRight("captureserver", "read")',			                // Use 'perms'=>'$user->rights->captureserver->level1->level2' if you want your menu with a permission rules
								'target'=>'',
								'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
